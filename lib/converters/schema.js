...
function convertSchema (schema, options) {
  ...
  if (typeof options.beforeTransform !== 'undefined') {
    schema = options.beforeTransform(schema, options);
  }
  ...
  var structs = options._structs;
	...
	if (typeof options.afterTransform !== 'undefined') {
		schema = options.afterTransform(schema, options);
	}
